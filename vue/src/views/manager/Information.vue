<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入资讯标题查询" style="width: 200px" v-model="name"></el-input>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="60%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="content" label="资讯内容">
          <!--          给页面咨询内容添加一个id标识,便于页面能找到初始化富文本的位置-->
          <div id="editor"></div>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="扶贫资讯" :visible.sync="editorVisible" width="50%" :close-on-click-modal="false"
               destroy-on-close>
